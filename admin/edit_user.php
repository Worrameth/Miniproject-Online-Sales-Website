...
<div class="d-flex justify-content-center">
  <form class="form-signin w-25 mt-5 pt-5" action="edit_user_action.php" method="post">
    <h1 class="h1 mb-3 font-weight-normal">แก้ไขข้อมูล</h1>

	<select class="browser-default custom-select mb-2" name="status">
    <option id="status" value="<?php echo $row_edit['status']; ?>" selected><?php echo $row_edit['status']; ?></option>
