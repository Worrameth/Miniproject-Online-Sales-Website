...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2020 at 10:40 PM
...
CREATE TABLE `bill_status` (
  ...
  `status_name` text COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `bill_status` (`status_id`, `status_name`) VALUES
(1, 'รอการตรวจสอบ'),
(2, 'ยืนยันแล้วรอการจัดส่ง'),
(3, 'ได้รับสินค้าแล้ว'),
(4, 'ไม่ผ่านการตรวจสอบ');
...
CREATE TABLE `gender` (
  ...
  `Gender_Full` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL
...
INSERT INTO `gender` (`Gender_ID`, `Gender_Full`) VALUES
(1, 'ชาย'),
(2, 'หญิง');
...
CREATE TABLE `order_head` (
  `oh_id` int(50) NOT NULL,
  `head_num` int(50) NOT NULL,
  `img` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `address` text COLLATE utf8_unicode_ci NOT NULL,
  `id_member` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `order_head` (`oh_id`, `head_num`, `img`, `address`, `id_member`, `date`, `status`) VALUES
(11, 1, '45067758220200410_020420.jpg', '84 ซ.29 ถ.กาญจนวนิชณ์ บางเหรียง    ควนเนียง    สงขลา    90220', 'member', '2020-04-10 02:04:20', 3),
(12, 2, '188016597320200410_022438.jpg', '84 ซ.29 ถ.กาญจนวนิชณ์ บางเหรียง    ควนเนียง    สงขลา    90220', 'member', '2020-04-10 02:24:38', 2),
(13, 3, '139624189220200410_142948.png', '84 ซ.29 ถ.กาญจนวนิชณ์ บางเหรียง    ควนเนียง    สงขลา    90220', 'member', '2020-04-10 14:29:48', 2),
(14, 4, '8395403320200410_195615.jpg', '84 ซ.29 ถ.กาญจนวนิชณ์ บางเหรียง    ควนเนียง    สงขลา    90220', 'member', '2020-04-10 19:56:15', 3),
(15, 5, '209833451420200410_224806.jpg', '84 ซ.29 ถ.กาญจนวนิชณ์ บางเหรียง    ควนเนียง    สงขลา    90220', 'member', '2020-04-10 22:48:06', 2),
(16, 6, '109547369820200410_224929.png', '84 ซ.29 ถ.กาญจนวนิชณ์ บางเหรียง    ควนเนียง    สงขลา    90220', 'member', '2020-04-10 22:49:29', 4),
(18, 7, '70956064920200411_000215.jpg', '84 ซ.29 ถ.กาญจนวนิชณ์ บางเหรียง    ควนเนียง    สงขลา    90220', 'member', '2020-04-11 00:02:15', 2),
(19, 8, '82148433520200411_220808.jpg', 'บ้าน คอหงส์    หาดใหญ่    สงขลา    90110', 'canzaza7', '2020-04-11 14:34:43', 2),
(20, 9, '151337808720200411_201000.jpg', 'บ้าน คอหงส์    หาดใหญ่    สงขลา    90110', 'canzaza7', '2020-04-11 20:10:00', 1);
...
INSERT INTO `order_product` (`or_id`, `id_product`, `id_user`, `amount`, `or_head`) VALUES
(32, 17, 'member', 2, 1),
(33, 18, 'member', 1, 1),
(34, 24, 'member', 1, 2),
(35, 63, 'member', 1, 2),
...
--
-- Table structure for table `per_id`
--

CREATE TABLE `per_id` (
  `Per_User` int(3) NOT NULL,
  `Per_Full` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `per_id`
--

INSERT INTO `per_id` (`Per_User`, `Per_Full`) VALUES
(1, 'Super Admin'),
(2, 'Admin'),
(3, 'User');
...
INSERT INTO `product_db` (`ID_Product`, `Name_Product`, `Picture`, `Description`, `Price`, `Stocks`, `type_id`, `total_sales`) VALUES
(16, 'Vinyl Gundam Thunderbolt OST-01:December Sky ', '30287391620200326_222407.jpg', 'Vinyl Gundam Thunderbolt OST-01:December Sky\r\nแผ่นเพลงเปิดในตำนานของการ์ตูณกันดั้มธันเดอร์โบลว์ ที่เก่าแก่แต่กลับทรงคุณค่า ด้วยทำนองอันแสนคุ้นหูที่คุณจะร้อง อ๋อ!! ทันทีเมื่อเสียงดนตรีบรรเลง', 1400, 0, 1, 0),
(17, 'Astro Boy : Original Soundtrack Vinyl', '132356077620200321_013442.png', 'แผ่นเสียงไวนิลเจ้าหนูปรมาณู เวอร์ชั่นทีวีซีรี่ย์', 650, 20, 1, 5),
(18, 'Astro Boy :Anniversary Collection  Vinyl', '13640356020200321_014007.png', 'แผ่นเสียงฉลองครบรอบการ์ตูนเจ้าหนูปรมาณู ที่รวบรวมเพลงติดหูของซีรี่ย์นี้มาให้ฟัง\r\nเช่น ANKH - As for me messenger of love (僕らは愛のメッセンジャー ) หรือ Kamitakada Boys Choir - Tetsuwan Atom', 1300, 13, 1, 1),
(19, 'แผ่นไวนิล วง:ไมโคร ชุด ร็อค เล็ก เล็ก', '74466708220200321_014646.png', 'แผ่นไวนิล วง:ไมโคร ชุด ร็อค เล็ก เล็ก ที่รวมเพลงฮิตหลายๆเพลงเช่น  อยากได้ดี  เรามันก็เป็นอย่างนี้ และเพลงอื่นอีกมากมายรวมไว้ให้คุณได้ฟัง ', 1250, 19, 1, 0),
(20, 'Synthwave project Neon Talk Vinyl : Pink', '12735582220200321_015622.jpg', 'แผ่นไวนิลที่รวบรวมเพลง Synth-Dance สำหรับขาแดนซ์เท้าไฟบนเวทีเต้นรำ ที่รอให้คุณเปิดฟังในวันที่นึกถึง ', 800, 5, 1, 1),
(22, 'Jelly Rocket : Lucid Dream VINYL', '167968130820200321_022133.jpg', 'Jelly Rocket : Lucid Dream VINYL รวมเพลงเพราะๆ ชิลๆ ของวง Jelly Rocket ให้คุณได้ฟังในวันที่ฟ้าหม่น ', 1990, 0, 1, 2),
(23, 'Vinly Ink Waruntorn : EP BLISS ', '19657360120200321_130112.jpg', 'INK WARUNTORN : EP BLISS (180 Gram Colour Vinyl ผลิตที่เยอรมัน) แผ่นเสียงสีสวยที่รวมเพลงฮิตทุกเพลงของ อิ้งค์ วรันธร และเพลงพิเศษอีก 1 เพลง\r\nรวมเพลงของอิ้งค์ ที่คุณคุ้นหูเช่น \r\nเหงา เหงา (Insomnia)\r\nฉันต้องคิดถึงเธอแบบไหน (Cloudy)', 1800, 12, 1, 0),
(24, 'Vinyl Silly Fools  : Juicy Albrum ', '114055752720200321_130752.jpg', 'จูซซี เป็นชื่ออัลบั้มเพลงชุดที่สี่ของวง ซิลลี่ ฟูลส์ ที่มีเพลงในตำนานอย่าง ผิดที่ไว้ใจ ขี้หึง โดยตัวแผ่นได้ถูกผลิตขึ้นมาใหม่ให้เก็บสะสมในจำนวนจำกัด!! ', 1650, 1, 1, 0),
(25, 'Cassette Tape Silly Fools : IQ108', '175616301620200321_131249.jpg', 'ตลับเพลงแสนหายากของวงในตำนาน ซิลลี่ฟูล ในชุด ไอ.คิว.108 เนื่องด้วยอัลบั้มนี้มีแนวดนตรีที่ค่อนข้างฟังยาก ทำให้ ซิลลี่ ฟูลส์ ยังไม่เป็นที่นิยมนักในสมัยนั้น แต่ในปัจจุปันกลับกลายเป็นชุดที่ผู้คนกลับใฝ่หา!! \r\nรวมเพลงที่ฟังแล้วทำให้คุณอยากตะโกน และ วิ่งไปชนกับฝูงคนไปมาอย่างสนุกสนาน เช่น เพลง พี่สาวครับอัดผมที  , สู้ไม่ได้  , เมื่อรักฉันเกิด ', 800, 1, 2, 0),
(26, 'Cassette Tape Silly Fools : Mint ', '145736923220200321_131518.jpg', 'อัลบั้มที่ได้รับการตอบรับที่ดีมาก ตั้งแต่ยังไม่วางแผง และเป็นอัลบั้มที่สามารถทำยอดขายได้สูงที่สุดของวง ซึ่งมียอดขายเกินกว่า 1 ล้านก็อปปี้ โดยอัลบั้มนี้รวมเพลงทุกรสชาติเข้าด้วยกันอย่างลงตัว โดยในแต่ละเพลงยังมีเสียงอิเล็กทรอนิกส์ เสียงสังเคราะห์ผสมเข้าไปในเพลงมากกว่าอัลบั้มที่แล้ว โดยทุกเพลงในชุดนี้ล้วนเป็นเพลงที่แฟนเพลงรู้จักและร้องตามกันได้ มาจนถึงทุกวันนี้ เพลงยอดฮิตและสามารถร้องตามได้จนถึงทุกวันนี้ได้แก่เพลง\r\n จิ๊จ๊ะ \r\nคิดถึง \r\nเพลงนี้เกี่ยวกับความรัก \r\nฟังดูง่ายง่าย', 800, 2, 2, 0),
(27, 'CD Silly Fools : KING SIZE ', '26432204720200321_131811.jpg', 'อัลบั้มเพลงชุดที่ห้าของวงดนตรี ซิลลี่ ฟูลส์ โดยเป็นชุดที่ยังคงความเป็นเอกลักษณ์ชวนหลงใหลของวงเอาไว้ไม่เปลี่ยนแปลง เน้นความเป็นตัวของตัวเอง \r\nถ่ายทอดออกมาโดยใช้ภาษาพูดเป็นส่วนใหญ่ และอาจจะเป็นชุดที่ได้รับความนิยมมากที่สุดของวงเลยก็ว่าได้\r\n เนื่องจากการตอบรับอันล้นหลามของชุดนี้สงผลให้ ซิลลี่ ฟูลส์ ขึ้นแท่นเป็นวงดนตรีอันดับ 1 ของไทยในเวลานั้น\r\n เพลงฮิตในอัลบั้มนี้ได้แก่เพลง \r\nน้ำลาย \r\nไม่หวั่นแม้วันมามาก \r\nหนึ่งเดียวของฉัน \r\nคนที่ฆ่าฉัน', 650, 0, 3, 1),
(28, 'DVD Silly Fools : The One Limited Edition ', '168517592320200321_132856.jpg', 'อัลบั้มเพลงชุดที่หกของวงดนตรี ซิลลี่ ฟูลส์ โดยชุดนี้มีความแปลกใหม่ โดย มี \"เบนจามิน จุง ทัฟเนล\" ลูกครึ่งเกาหลี-อเมริกัน มาเป็นนักร้องนำ\r\nและยังได้รับ อัลบั้ม The One ในรูปแบบ Limited Edition โดยเป็นการเปลี่ยนเนื้อเพลงจากภาษาไทย เป็นภาษาอังกฤษ แต่ใช้ดนตรีเดิม !!\r\nเพลงฮิตในอัลบั้มนี้ได้แก่เพลง โง่(Enough),เราเป็นคนเลือกเอง(No Regrets ), รั้งรอ(Nevermind) และเหนื่อยแล้ว(Unhappy Ending)\r\n', 700, 0, 3, 0),
(29, 'Cassette Tape Silly Fools : Candy Man !', '30928002520200321_133457.jpg', 'อัลบั้มเพลงชุดที่สองของวง ซิลลี่ ฟูลส์ โดยอัลบั้มชุดนี้จะเน้นเพลงช้าและเพลงจังหวะปานกลาง เป็นอัลบั้มที่มีการเปลี่ยนแปลงแนวเพลงของวง กระแสในตอนนั้นกลับไปดีเท่าที่ควร แต่ในปัจจุบันกับเป็นอัลบั้มที่แค่คุณได้ยินเสียงดนตรีขึ้นคุณก็เผลอฮัมเพลงของพวกเขาโดยไม่รู้ตัว! โดยอัลบั้มชุดนี้เป็นชุดแรกที่ Simon Henderson มาเป็นโปรดิวเซอร์ร่วมกับวง และมิกซ์เสียงอัลบั้มชุดนี้ด้วย เพลงฮิตในอัลบั้มนี้ได้แก่เพลง \r\nฝัน\r\nอย่าบอกว่ารัก \r\nไหนว่าจะไม่หลอกกัน \r\nเพียงรัก ', 800, 1, 2, 0),
(30, 'CD Silly Fools : E.P', '121766339120200321_134030.jpg', 'ซีดีของวงซิลลี่ฟูลส์ ที่ถูกปล่อยมาอย่างพิเศษและหาเก็บได้ยาก \r\nในอัลบั้มประกอบด้วยเพลง:\r\nว่างเปล่า\r\nรอยยิ้ม (ภาคทฤษฎี)\r\n จิบเดียว...ก็ซึ้งแมน\r\nรอยยิ้ม (ภาคปฏิบัติ)', 999, 1, 3, 0),
(31, 'CD: Hangman Album', '76988145820200321_140614.jpg', 'ซีดีของวง แฮงค์แมน โดยในเพลงประกอบด้วยเพลง \r\n1.พยายามกี่ครั้งก็ตามแต่\r\n2.รักเธอหัวทิ่มบ่อ\r\n3.สัญญาณในใจ', 300, 0, 3, 1),
(32, 'Nintendo Gameboy color(Purple)', '151970211920200321_141250.jpg', 'เครื่องเกม Nintendo Gameboy Color สีม่วง \r\nเครื่องเกมในตำนานของบริษัท Nintendo ที่จะพาคุณย้อนวัยไปกลับเกมเก่าๆเช่น 3D Pocket Pool,Pokémon Crystal\r\n*หมายเหตุไม่แถมตลับเกม', 800, 1, 6, 0),
(33, 'Nintendo Gameboy color(Yellow)', '164660128320200321_141329.jpg', 'เครื่องเกม Nintendo Gameboy Color สีเหลือง\r\nเครื่องเกมในตำนานของบริษัท Nintendo ที่จะพาคุณย้อนวัยไปกลับเกมเก่าๆเช่น 3D Pocket Pool,Pokémon Crystal\r\n*หมายเหตุไม่แถมตลับเกม', 800, 1, 6, 0),
(34, 'Nintendo Gameboy color(ฺBlue)', '90723472120200321_141430.jpg', 'เครื่องเกม Nintendo Gameboy Color สีน้ำเงิน\r\nเครื่องเกมในตำนานของบริษัท Nintendo ที่จะพาคุณย้อนวัยไปกลับเกมเก่าๆเช่น 3D Pocket Pool,Pokémon Crystal\r\n*หมายเหตุไม่แถมตลับเกม', 800, 1, 6, 0),
(35, 'Nintendo Gameboy color(Light Blue)', '191560227620200321_141528.jpg', 'เครื่องเกม Nintendo Gameboy Color สีน้ำเงินอ่อน \r\nเครื่องเกมในตำนานของบริษัท Nintendo ที่จะพาคุณย้อนวัยไปกลับเกมเก่าๆเช่น 3D Pocket Pool,Pokémon Crystal\r\n*หมายเหตุไม่แถมตลับเกม', 800, 1, 6, 0),
(36, 'ตลับGameboy Color :Card Captor Sakura', '69173515220200321_143034.jpg', 'เกมจากการ์ตูนชื่อดังในอดีต ซากุระ มือปราบไพ่ทาโรต์ โดยตัวเกมจะเป้นแบบมินิเกม สไตล์กีฬาสีในโรงเรียนของซากุระ', 300, 1, 6, 0),
(37, 'ตลับเกม Gameboy Color :Gundam Kunitorimonogatari', '140627974720200321_143420.jpg', 'ตลับเกมจากการ์ตูนชื่อดัง เอสดี กันดั้ม ศึกตำนานสามก๊ก ซึ่งรูปแบบเกมเป็นรูปแบบการเล่นในแนว RPG โดยผู้เล่นจะได้ควบคุมตัวละครไปยึดดินแดนของฝ่ายตรงข้าม และมี มินิเกมแฝงในแต่ล่ะแดนที่แตกต่างกัยไป ', 500, 1, 6, 0),
(38, 'ตลับเกม Gameboy Color : Kunio Kun Soccer', '200597784120200321_143919.jpg', 'สวมบทบาทเป็นนักเรียนในคุนิโอะ ในวันที่ลงสนามประลองความเร็วของแข้งในสนามฟุตบอล อันแสนเดือด 1 ในเกมที่แสนสนุกจากซีรี่ย์คุนิโอะ เลือดเดือด!', 150, 1, 6, 0),
(39, 'ตลับเกม Gameboy Color: NEKKETSU! BEACH VOLLEY DAYO KUNIO KUN', '141497214520200321_144408.jpg', '1ในเกมของซีรี่ย์ในความทรงจำ คุนิโอะ คนเลือดเดือด ในวันที่อากาศร้อนเหล่านักเรียนได้ไปเที่ยวชายหาดเพื่อคลายร้อยแต่มีรึที่การเที่ยวของพวกเขาจะธรรมดา \r\nพบกับการดวล วอลเลย์บอลชายหาดอันเดือดดาด ของเหล่านักเรียนคุนิโอะ!! ', 200, 2, 6, 0),
(40, 'ของเล่น TOMY POP CYCLES', '154056940920200321_150027.jpg', '-', 35, 25, 6, 0),
(42, 'TAMIYA MINI 4WD HYPER-DASH3 MOTOR (แท้)', '179851106520200321_150758.jpg', 'มอเตอร์รถทามิย่า HYPER-DASH3 สำหรับการขับเคลื่อนสี่ล้อของรถทามิย่ารุ่นใหม่!', 180, 15, 6, 0),
(43, 'Tamiya AVANTE 2001jr 1/38 RACING MINI 4WD SERIES No.31 ', '207372514220200321_154746.jpg', 'รถทามิย่า AVANTE 2001jr 1/38 RACING MINI 4WD SERIES No.31 ', 400, 2, 6, 0),
(44, 'TAMIYA SLASH REAPER 1/32 MINI 4WD SERIES  ', '99562391620200321_155013.jpg', '-', 450, 1, 6, 0),
(45, 'Tamiya Thunder Shot MK.II (Pink Special)', '163840038520200321_155226.jpg', 'รถทามิย่า Thunder Shot MK.II 4WD Limited Edition สีชมพู', 800, 1, 6, 0),
(46, 'ลูกอมโกโก้ ตรา Lucky (3โหล)', '85513720200321_160052.jpg', 'ลูกอมโกโก้เคี้ยวหนึบ ตราLucky หรือที่เราเรียกกันว่า โกโก้หัวโต !! \r\nจัดจำหน่าย 1ชุด ได้ 3 โหล ', 100, 50, 6, 0),
(47, 'ช๊อคโกแล็ตเคลือบขนมปัง ตรา โดราเอม่อน', '37424628820200321_160219.jpg', 'ช๊อคโกแล็ตเคลือบขนมปัง ตรา โดราเอม่อน \r\nจัดจำหน่าย 1ชุดได้รับ 2 โหล ', 50, 100, 6, 0),
(48, 'หมากฝรั่งรสมินต์เคี้ยวหนึบ ตราแมว', '193332035220200321_160605.jpg', 'หมากฝรั่งเคี้ยวหนึบ \"ตราแมว\" หรือ \"บุหรี่ตราแมว\" หมากฝรั่งสุดเท่ในอดีตกาล \r\nจัดจำหน่าย 1ชุด 3กล่อง', 25, 100, 6, 0),
(49, 'Playstation 2 + Joys Controller สภาพดี ของแท้ เปิดได้ 100%', '168697087420200321_163936.jpg', 'Playstation 2 + Joys Controller สภาพดี ของแท้ เปิดได้ 100% \r\n', 1450, 4, 6, 0),
(51, '80s Colored Vinyl Album Cover', '29921577620200321_180714.png', 'Vinyl Record Cover for the art and synthwave project Neon Talk - Trying Hard. Genre: Synthwave, 80s influenced electronic music.\r\n\r\n', 850, 2, 0, 0),
(53, 'test', '17940503220200321_205008.jpg', 'test', 123, 123, 0, 0),
(54, 'test', '38953142920200321_234107.jpg', '้ดเ้เ้้้เ้', 55, 55, 0, 0),
(55, 'erter', '110921651920200322_000210.jpg', 'terterter', 2, 3, 0, 0),
(56, 'erter', '197639623720200322_000311.jpg', 'terterter', 2, 3, 0, 0),
(57, 'erter', '171382736820200407_210632.jpg', 'terterter', 2, 3, 0, 0),
(58, 'ewrwerwer', '149787991020200322_000436.jpg', 'werwerwer', 3, 4, 6, 0),
(63, 'พี่โตไม่เล็ก', '171583610420200322_221129.jpg', 'พี่โตชายกล้ามโต', 6969, 0, 1, 0),
(64, 'erter2', '55259930120200412_012311.jpg', 'dddd', 345, 6565, 0, 0);
...
INSERT INTO `type_product` (`type_id`, `name_id`) VALUES
(1, 'Vinyl'),
(2, 'Cassette Tape'),
(3, 'CD-Video Tape'),
(6, 'Orther (Toys ETC.)');
...
CREATE TABLE `user_db` (
  ...
  `status` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'member'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_db` (`ID_User`, `Password`, `Name`, `Last_Name`, `Email`, `Gender`, `Address`, `City`, `Province`, `Postcode`, `District`, `status`) VALUES
('admin', 'admin', 'pond', 'lnwza', 'admin@gmail.com', 1, 'dyyyo111', '924', 70, 4444, '900710', 'admin'),
('canzaza100', '12345', 'can', 'xaxa', 'canzz555@hotmail.com', 1, 'บ้าน', '928', 70, 90110, '901104', 'manager'),
('canzaza7', '123456789', 'super', 'com', 'canzz55@hotmail.com', 1, 'บ้าน', '928', 70, 90110, '901104', 'member'),
('canzaza8', '123456789', 'super', 'com', 'canzwerwerz55@hotmail.com', 1, 'บ้าน', '283', 21, 90110, '321103', 'member'),
('canzaza99', '123456789', 'super', 'com', 'canzz55@hotmail.com', 1, 'บ้าน', '231', 19, 90110, '301711', 'member'),
('fvdg', '11111', 'hnhg', 'hg', '', 1, 'hhffg', '198', 16, 9999, '251008', 'member'),
('gfdg', '11111', 'vfv', 'bcb', '', 1, 'xv', '184', 15, 555, '240703', 'member'),
('ggggg', '123456', 'gggg', 'ggggg', '', 1, 'บ้าน', '186', 15, 999, '240904', 'member'),
('kuy', '123456', 'lek', 'yai', '', 1, 'บ้าน', '928', 70, 1150, '901105', 'manager'),
('manager', 'manager', 'manager', 'sogoodgood', 'manager@gmail.com', 1, 'บ้านผมเองนะครับ', '823', 61, 99900, '760401', 'manager'),
('member', 'member', 'nattapon', 'saeliw', 'member@gmail.com', 1, '84 ซ.29 ถ.กาญจนวนิชณ์', '930', 70, 90220, '901304', 'member'),
('nutty', '147258369', 'nutt', 'yed', 'yed@hotmail.com', 1, 'บ้าน', '174', 14, 99900, '230403', 'member'),
('pond', '123456789', 'pond', 'zaza', 'ggggg@hotmail.com', 1, 'บ้าน', '184', 15, 9999, '240703', 'member'),
('Super', '123456', 'super', 'com', '', 1, 'บ้าน', '185', 15, 5555, '240803', 'member'),
('test', '123456', 'test555', 'test666', 'test777@hotmail.com', 1, 'test888', '139', 11, 11235, '200404', 'member'),
('werwerwerwerwerwer', '1', '1213123', '123123', 'canzz55@hotmail.com', 1, 'ghghg', '203', 17, 90110, '260202', 'member'),
('xxxx', '123456', 'aaaaa', 'bbbbbb', '', 1, 'eeeeee', '928', 70, 234234, '901104', 'member'),
('zazaza', '123456789', 'xaaxaxa', 'xaazazaza', 'kuy@hotmail.com', 1, '555', '203', 17, 90321, '260203', 'manager');
...
INSERT INTO `user_id` (`ID_User`, `Pass_User`, `Per_User`) VALUES
('Pond', '123456', 1);
...
--
ALTER TABLE `order_head`
  MODIFY `oh_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `order_product`
--
ALTER TABLE `order_product`
  MODIFY `or_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `product_db`
--
ALTER TABLE `product_db`
  MODIFY `ID_Product` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `type_product`
  MODIFY `type_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
COMMIT;
