...
<div class="d-flex justify-content-center">
  <form class="form-signin w-25 mt-5 pt-5" action="edit_address_action.php" method="post">
    <h1 class="h1 mb-3 font-weight-normal">ข้อมูลการจัดส่ง</h1>
    
     <!-- ล่องหน --><input style="opacity: 0;" type="text" name="txt_user" value="<?php echo $row_edit['ID_User']; ?>" checked="checked">  <!-- ล่องหน -->
